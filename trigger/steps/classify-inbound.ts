...
- **partial_release / partial_delivery**: Agency provides some records with more to follow later. CRITICAL: Records must be ACTUALLY ATTACHED or DELIVERED in this message. If the agency says "we will release X records once you pay" or "records available after payment", this is a **fee_request** — no records have been delivered yet. A letter describing what will be released alongside a fee invoice is NOT a partial_delivery.
