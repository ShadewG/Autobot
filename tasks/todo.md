...
- [ ] Finish portal confirmation / portal release false-action cleanup: representative inert confirmation case `real:portal_confirmation:768` now correctly produces no action, but the substantive outliers (`real:portal_confirmation:706/607`, `real:portal_release:867/669`) still need review to separate stale expected labels from real routing bugs `(Evidence: targeted no-action match on localhost:39003 at 2026-03-09T09:25:58.799Z; remaining outliers from tests/reports/email-scenario-batch-report.json)`
